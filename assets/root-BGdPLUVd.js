const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/browser-ponyfill-BZXeir8D.js',
      'assets/chunk-PVWAREVJ-CRWIe_p6.js',
    ])
) => i.map((i) => d[i]);
import {
  w as Qe,
...
import { P as rt } from './react-redux-BgHxNhCb.js';
import {
  a as ot,
  b as at,
  l as lt,
  d as ut,
  e as ft,
} from './i18nInstance-CYZvC-rk.js';
import { L as ct } from './index-B4Rfb_Vg.js';
/* empty css              */ const dt = { status: !1, name: null },
  Ae = ot({
    name: 'user',
    initialState: dt,
    reducers: {
  ...
  ht = Ae.reducer,
  pt = at({ reducer: { user: ht, lang: lt } }),
  On = () => [{ title: 'Postman Clone' }],
  Ln = () => [
  ...
  mt = /###/g,
  pe = (s) => (s && s.indexOf('###') > -1 ? s.replace(mt, '.') : s),
  ge = (s) => !s || g(s),
  B = (s, e, t) => {
    ...
    for (; i < n.length - 1; ) {
      ...
      const r = pe(n[i]);
      (!s[r] && t && (s[r] = new t()),
        Object.prototype.hasOwnProperty.call(s, r) ? (s = s[r]) : (s = {}),
        ++i);
    }
    return ge(s) ? {} : { obj: s, k: pe(n[i]) };
  },
  me = (s, e, t) => {
    const { obj: n, k: i } = B(s, e, Object);
    ...
    for (; a.obj === void 0 && o.length; )
      ((r = `${o[o.length - 1]}.${r}`),
        ...
        a != null &&
          a.obj &&
          typeof a.obj[`${a.k}.${r}`] < 'u' &&
          (a.obj = void 0));
    a.obj[`${a.k}.${r}`] = t;
  },
  yt = (s, e, t, n) => {
    const { obj: i, k: r } = B(s, e, Object);
    ((i[r] = i[r] || []), i[r].push(t));
  },
  G = (s, e) => {
    const { obj: t, k: n } = B(s, e);
...
const St = (s) => (g(s) ? s.replace(/[&<>"'\/]/g, (e) => bt[e]) : s);
class vt {
  constructor(e) {
    ((this.capacity = e),
...
const wt = [' ', ',', '?', '!', ';'],
  ...
  Lt = (s, e, t) => {
    ((e = e || ''), (t = t || ''));
    const n = wt.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
  ...
  Pt = {
    ...
    output(s, e) {
      var t, n;
      (n =
        (t = console == null ? void 0 : console[s]) == null
          ? void 0
...
class Z {
  ...
  forward(e, t, n, i) {
    return i && !this.debug
      ? null
      : (g(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`), this.logger[t](e));
  }
  create(e) {
...
class ne {
  ...
  emit(e, ...t) {
    (this.observers[e] &&
      Array.from(this.observers[e].entries()).forEach(([i, r]) => {
        for (let o = 0; o < r; o++) i(...t);
      }),
      this.observers['*'] &&
        Array.from(this.observers['*'].entries()).forEach(([i, r]) => {
          for (let o = 0; o < r; o++) i.apply(i, [e, ...t]);
        }));
  }
}
class ye extends ne {
  ...
  addResource(e, t, n, i, r = { silent: !1 }) {
    const o =
  ...
  addResources(e, t, n, i = { silent: !1 }) {
    for (const r in n)
      (g(n[r]) || Array.isArray(n[r])) &&
        this.addResource(e, t, r, n[r], { silent: !0 });
    i.silent || this.emit('added', e, t, n);
  }
  addResourceBundle(e, t, n, i, r, o = { silent: !1, skipCopy: !1 }) {
    let a = [e, t];
  ...
  handle(s, e, t, n, i) {
    return (
      s.forEach((r) => {
        var o;
        e =
          ((o = this.processors[r]) == null ? void 0 : o.process(e, t, n, i)) ??
          e;
      }),
      e
    );
  ...
  return (
    (e.get = (n, i) => {
      ...
      return (
        ...
        i === Ve ? s : (s.push(i), (t = Proxy.revocable(n, e)), t.proxy)
      );
    }),
...
const xe = {},
  be = (s) => !g(s) && typeof s != 'boolean' && typeof s != 'number';
class ee extends ne {
  constructor(e, t = {}) {
    (super(),
      gt(
  ...
  extractFromKey(e, t) {
    ...
    if (o && !a) {
      ...
      if (l && l.length > 0) return { key: e, namespaces: g(r) ? [r] : r };
      const u = e.split(n);
      ((n !== i || (n === i && this.options.ns.indexOf(u[0]) > -1)) &&
        (r = u.shift()),
        (e = u.join(i)));
    }
    return { key: e, namespaces: g(r) ? [r] : r };
  }
  translate(e, t, n) {
    ...
    if (
      ...
      return '';
    (typeof e == 'function' && (e = oe(e, { ...this.options, ...i })),
    ...
    const m = (h == null ? void 0 : h.usedKey) || a,
      y = (h == null ? void 0 : h.exactUsedKey) || a,
      P = ['[object Number]', '[object Function]', '[object RegExp]'],
      L = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays,
      F = !this.i18nFormat || this.i18nFormat.handleAsObject,
      v = i.count !== void 0 && !g(i.count),
      $ = ee.hasDefaultValue(i),
      W = v ? this.pluralResolver.getSuffix(f, i.count, i) : '',
      E =
        i.ordinal && v
          ? this.pluralResolver.getSuffix(f, i.count, { ordinal: !1 })
          : '',
      M = v && !i.ordinal && i.count === 0,
      w =
        (M && i[`defaultValue${this.options.pluralSeparator}zero`]) ||
        i[`defaultValue${W}`] ||
        i[`defaultValue${E}`] ||
        i.defaultValue;
    let S = d;
    F && !d && $ && (S = w);
    const Je = be(S),
      We = Object.prototype.toString.apply(S);
    if (F && S && Je && P.indexOf(We) < 0 && !(g(L) && Array.isArray(S))) {
      if (!i.returnObjects && !this.options.returnObjects) {
        ...
        const k = this.options.returnedObjectHandler
          ? this.options.returnedObjectHandler(m, S, { ...i, ns: l })
          : `key '${a} (${this.language})' returned an object instead of string.`;
        return r
          ? ((h.res = k), (h.usedParams = this.getUsedParamsDetails(i)), h)
          : k;
      }
      if (o) {
        const k = Array.isArray(S),
          ...
          ue = k ? y : m;
        for (const j in S)
          if (Object.prototype.hasOwnProperty.call(S, j)) {
            const N = `${ue}${o}${j}`;
            ($ && !d
              ? (C[j] = this.translate(N, {
                  ...i,
                  defaultValue: be(w) ? w[j] : void 0,
                  joinArrays: !1,
                  ns: l,
                }))
              : (C[j] = this.translate(N, { ...i, joinArrays: !1, ns: l })),
              C[j] === N && (C[j] = S[j]));
          }
        d = C;
      }
    } else if (F && g(L) && Array.isArray(d))
      ((d = d.join(L)), d && (d = this.extendTranslation(d, e, i, n)));
    else {
      let k = !1,
        C = !1;
      (!this.isValidLookup(d) && $ && ((k = !0), (d = w)),
      ...
      const j =
          ...
          C
            ? void 0
            : d,
        N = $ && w !== d && this.options.updateMissing;
      if (C || k || N) {
        if (
          (this.logger.log(N ? 'updateKey' : 'missingKey', f, u, a, N ? w : d),
          o)
        ) {
          const O = this.resolve(a, { ...i, keySeparator: !1 });
          O &&
            O.res &&
            this.logger.warn(
        ...
        if (this.options.saveMissingTo === 'fallback' && Q && Q[0])
          for (let O = 0; O < Q.length; O++) K.push(Q[O]);
        else
        ...
        const fe = (O, D, _) => {
          ...
          (this.options.missingKeyHandler
            ? this.options.missingKeyHandler(O, u, D, ce, N, i)
            : (de = this.backendConnector) != null &&
              de.saveMissing &&
              this.backendConnector.saveMissing(O, u, D, ce, N, i),
            this.emit('missingKey', O, u, D, d));
        };
        this.options.saveMissing &&
          (this.options.saveMissingPlurals && v
            ? K.forEach((O) => {
                const D = this.pluralResolver.getSuffixes(O, i);
                (M &&
                  ...
                  D.forEach((_) => {
                    fe([O], a + _, i[`defaultValue${_}`] || w);
                  }));
              })
            : fe(K, a, w));
      }
      ((d = this.extendTranslation(d, e, i, h, n)),
        C &&
          d === a &&
    ...
    return r
      ? ((h.res = d), (h.usedParams = this.getUsedParamsDetails(i)), h)
      : d;
  }
  ...
  resolve(e, t = {}) {
    ...
    return (
      ...
      e.forEach((l) => {
        ...
        const p = t.count !== void 0 && !g(t.count),
          h = p && !t.ordinal && t.count === 0,
          d =
            t.context !== void 0 &&
            (g(t.context) || typeof t.context == 'number') &&
            t.context !== '',
          m = t.lngs
            ? t.lngs
        ...
        f.forEach((y) => {
          ...
          this.isValidLookup(n) ||
            ...
            !xe[`${m[0]}-${y}`] &&
              ...
              !((L = this.utils) != null && L.hasLoadedNamespace(a)) &&
              ((xe[`${m[0]}-${y}`] = !0),
              this.logger.warn(
            ...
            m.forEach((F) => {
              ...
              if ((W = this.i18nFormat) != null && W.addLookupKeys)
                this.i18nFormat.addLookupKeys(v, c, F, y, t);
              else {
                let E;
                p && (E = this.pluralResolver.getSuffix(F, t.count, t));
                ...
                if (
                  (p &&
                    (t.ordinal &&
                      E.indexOf(w) === 0 &&
                      v.push(c + E.replace(w, this.options.pluralSeparator)),
                    v.push(c + E),
                    h && v.push(c + M)),
                  d)
                ) {
                  ...
                  (v.push(S),
                    p &&
                      (t.ordinal &&
                        E.indexOf(w) === 0 &&
                        v.push(S + E.replace(w, this.options.pluralSeparator)),
                      v.push(S + E),
                      h && v.push(S + M)));
                }
              }
              ...
              for (; ($ = v.pop()); )
                this.isValidLookup(n) ||
                  ((r = $), (n = this.getResource(F, y, $, t)));
            }));
        });
      }),
      { res: n, usedKey: i, exactUsedKey: r, usedLng: o, usedNS: a }
    );
  }
  isValidLookup(e) {
    return (
  ...
  toResolveHierarchy(e, t) {
    ...
    return (
      g(e) && (e.indexOf('-') > -1 || e.indexOf('_') > -1)
        ...
        : g(e) && r(this.formatLanguageCode(e)),
      n.forEach((o) => {
...
const ve = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  we = {
  ...
  getSuffixes(e, t = {}) {
    ...
    return (
      ...
      n
        ? n
            .resolvedOptions()
            .pluralCategories.sort((i, r) => ve[i] - ve[r])
            .map(
              (i) =>
...
const Oe = (s, e, t, n = '.', i = !0) => {
    let r = xt(s, e, t);
    return (
      !r && i && g(t) && ((r = re(s, t, n)), r === void 0 && (r = re(e, t, n))),
      r
    );
  },
  ie = (s) => s.replace(/\$/g, '$$$$');
class jt {
  ...
  init(e = {}) {
    ...
    ((this.escape = t !== void 0 ? t : St),
      ...
      (this.nestingPrefix = p ? A(p) : h || A('$t(')),
      (this.nestingSuffix = d ? A(d) : m || A(')')),
  ...
  interpolate(e, t, n, i) {
      ...
      u = (d) => {
        if (d.indexOf(this.formatSeparator) < 0) {
          ...
          return this.alwaysFormat
            ? this.format(L, void 0, n, { ...i, ...t, interpolationkey: d })
            : L;
        }
        const m = d.split(this.formatSeparator),
          y = m.shift().trim(),
          P = m.join(this.formatSeparator).trim();
        return this.format(
          Oe(
            t,
            l,
    ...
    return (
      [
        { regex: this.regexpUnescape, safeValue: (d) => ie(d) },
        {
          regex: this.regexp,
        ...
        for (a = 0; (r = d.regex.exec(e)); ) {
          ...
          const y = d.safeValue(o);
          if (
            ((e = e.replace(r[0], y)),
            f
              ? ((d.regex.lastIndex += o.length),
  ...
  nest(e, t, n = {}) {
    ...
    for (; (i = this.nestingRegexp.exec(e)); ) {
      let l = [];
      ((o = { ...n }),
        (o = o.replace && !g(o.replace) ? o.replace : o),
      ...
      (g(r) || (r = he(r)),
        ...
        l.length &&
          (r = l.reduce(
            (c, f) =>
              this.format(c, f, n.lng, { ...n, interpolationkey: i[1].trim() }),
            r.trim()
          )),
        (e = e.replace(i[0], r)),
...
class Et {
  ...
  init(e, t = { interpolation: {} }) {
    ...
    const n = t.cacheInBuiltFormats ? Le : $t;
    this.formats = {
      number: n((i, r) => {
        const o = new Intl.NumberFormat(i, { ...r });
        return (a) => o.format(a);
      }),
      currency: n((i, r) => {
        const o = new Intl.NumberFormat(i, { ...r, style: 'currency' });
        return (a) => o.format(a);
      }),
      datetime: n((i, r) => {
      ...
      relativetime: n((i, r) => {
        const o = new Intl.RelativeTimeFormat(i, { ...r });
        return (a) => o.format(a, r.range || 'day');
      }),
      list: n((i, r) => {
        const o = new Intl.ListFormat(i, { ...r });
        return (a) => o.format(a);
      }),
    };
  }
  ...
  format(e, t, n, i = {}) {
    ...
    return r.reduce((a, l) => {
      var f;
      const { formatName: u, formatOptions: c } = Rt(l);
      if (this.formats[u]) {
        let p = a;
        try {
          const h =
            ...
            d = h.locale || h.lng || i.locale || i.lng || n;
          p = this.formats[u](a, d, { ...c, ...i, ...h });
        } catch (h) {
          this.logger.warn(h);
        }
        return p;
...
class Ft extends ne {
  constructor(e, t, n, i = {}) {
    ...
    (super(),
      ...
      (this.state = {}),
      (this.queue = []),
      (o = (r = this.backend) == null ? void 0 : r.init) == null ||
  ...
  loaded(e, t, n) {
    ...
    (t && this.emit('failedLoading', r, o, t),
      !t &&
        n &&
        this.store.addResourceBundle(r, o, n, void 0, void 0, { skipCopy: !0 }),
      (this.state[e] = t ? -1 : 2),
      t && n && (this.state[e] = 0));
    const a = {};
  ...
  loadOne(e, t = '') {
    ...
    this.read(i, r, 'read', void 0, void 0, (o, a) => {
      (o &&
        ...
        !o &&
          a &&
          this.logger.log(`${t}loaded namespace ${r} for language ${i}`, a),
        this.loaded(e, o, a));
    });
  }
  saveMissing(e, t, n, i, r, o = {}, a = () => {}) {
    ...
    if (!(n == null || n === '')) {
      if ((p = this.backend) != null && p.create) {
        const h = { ...o, isUpdate: r },
          d = this.backend.create.bind(this.backend);
        if (d.length < 6)
          try {
            let m;
            (d.length === 5 ? (m = d(e, t, n, i, h)) : (m = d(e, t, n, i)),
              m && typeof m.then == 'function'
                ? m.then((y) => a(null, y)).catch(a)
                : a(null, m));
          } catch (m) {
            a(m);
          }
...
const Pe = () => ({
    ...
    overloadTranslationOptionHandler: (s) => {
      ...
      if (
        ...
        g(s[1]) && (e.defaultValue = s[1]),
        g(s[2]) && (e.tDescription = s[2]),
  ...
  Ce = (s) => {
    ...
    return (
      g(s.ns) && (s.ns = [s.ns]),
      g(s.fallbackLng) && (s.fallbackLng = [s.fallbackLng]),
      g(s.fallbackNS) && (s.fallbackNS = [s.fallbackNS]),
      ((t = (e = s.supportedLngs) == null ? void 0 : e.indexOf) == null
        ? void 0
        : t.call(e, 'cimode')) < 0 &&
...
class X extends ne {
  ...
  init(e = {}, t) {
    ...
    const n = Pe();
    ((this.options = { ...n, ...this.options, ...Ce(e) }),
      (this.options.interpolation = {
        ...n.interpolation,
        ...this.options.interpolation,
      }),
    ...
    if (!this.options.isClone) {
      this.modules.logger
        ? R.init(i(this.modules.logger), this.options)
      ...
      ((f.logger = R),
        ...
        (f.interpolator = new jt(this.options)),
        (f.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
        (f.backendConnector = new Ft(
          i(this.modules.backend),
          f.resourceStore,
          f,
          this.options
        )),
        f.backendConnector.on('*', (h, ...d) => {
          this.emit(h, ...d);
        }),
    ...
    if (
      ...
      (i
        ...
        : this.services.languageUtils
            ...
            .forEach((c) => l(c)),
        (o = (r = this.options.preload) == null ? void 0 : r.forEach) == null ||
          o.call(r, (u) => l(u)),
      ...
      o = (a) => {
        ...
        const l = g(a) ? a : a && a[0],
          u = this.store.hasLanguageSomeTranslations(l)
            ? l
            : this.services.languageUtils.getBestMatchFromCodes(g(a) ? [a] : a);
        (u &&
          (this.language || i(u),
  ...
  getFixedT(e, t, n) {
    const i = (r, o, ...a) => {
      let l;
      (typeof o != 'object'
        ? (l = this.options.overloadTranslationOptionHandler([r, o].concat(a)))
        : (l = { ...o }),
        (l.lng = l.lng || i.lng),
      ...
      return (
        l.keyPrefix && Array.isArray(r)
          ? (c = r.map(
              (f) => (
                typeof f == 'function' &&
                  (f = oe(f, { ...this.options, ...o })),
                `${l.keyPrefix}${u}${f}`
              )
            ))
          : (typeof r == 'function' && (r = oe(r, { ...this.options, ...o })),
            (c = l.keyPrefix ? `${l.keyPrefix}${u}${r}` : r)),
        this.t(c, l)
      );
    };
    return (
      g(e) ? (i.lng = e) : (i.lngs = e),
      (i.ns = t),
      (i.keyPrefix = n),
      i
    );
  ...
  cloneInstance(e = {}, t = Y) {
    ...
    return (
      (r.translator = new ee(r.services, i)),
      r.translator.on('*', (a, ...l) => {
        r.emit(a, ...l);
      }),
      r.init(i, t),
...
const b = X.createInstance();
b.createInstance = X.createInstance;
b.createInstance;
b.dir;
b.init;
b.loadResources;
...
function Me() {
  return (
    ...
    (typeof XMLHttpRequest > 'u' ? 'undefined' : ae(XMLHttpRequest)) ===
      'object'
  );
}
function It(s) {
...
function At(s) {
  return It(s) ? s : Promise.resolve(s);
}
...
typeof global < 'u' && global.fetch
  ? (T = global.fetch)
  : typeof window < 'u' && window.fetch && (T = window.fetch);
var J;
Me() &&
  (typeof global < 'u' && global.XMLHttpRequest
    ? (J = global.XMLHttpRequest)
    : typeof window < 'u' &&
      window.XMLHttpRequest &&
      (J = window.XMLHttpRequest));
var te;
typeof ActiveXObject == 'function' &&
  (typeof global < 'u' && global.ActiveXObject
    ? (te = global.ActiveXObject)
    : typeof window < 'u' &&
      window.ActiveXObject &&
      (te = window.ActiveXObject));
typeof T != 'function' && (T = void 0);
if (!T && !J && !te)
  try {
    Vt(
      () => import('./browser-ponyfill-BZXeir8D.js').then((s) => s.b),
      __vite__mapDeps([0, 1])
    )
      .then(function (s) {
        T = s.default;
...
var le = function (e, t) {
  ...
  Bt = function (e, t, n, i) {
    (n && I(n) === 'object' && (n = le('', n).slice(1)),
      e.queryStringParams && (t = le(t, e.queryStringParams)));
    try {
      var r = J ? new J() : new te('MSXML2.XMLHTTP.3.0');
      ...
      ((r.onreadystatechange = function () {
        r.readyState > 3 &&
          i(r.status >= 400 ? r.statusText : null, {
            status: r.status,
            data: r.responseText,
          });
      }),
  ...
  zt = function (e, t, n, i) {
    if (
      ...
      return qt(e, t, n, i);
    if (Me() || typeof ActiveXObject == 'function') return Bt(e, t, n, i);
...
function Jt(s, e) {
  for (var t = 0; t < e.length; t++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      ...
      Object.defineProperty(s, _e(n.key), n));
  }
}
function Wt(s, e, t) {
  return (
    ...
    return Wt(s, [
      {
        ...
        value: function (t) {
          ...
          if (
            ((this.services = t),
            (this.options = se(se(se({}, Yt()), this.options || {}), i)),
            (this.allOptions = r),
        ...
        value: function (t, n, i, r) {
          ...
          this.options.request(this.options, t, u, function (c, f) {
            ...
            if (!f && c && c.message) {
              ...
              if (h) return n('failed loading ' + t + ': ' + c.message, !0);
            }
            if (c) return n(c, !1);
            var d, m;
            try {
              typeof f.data == 'string'
                ? (d = o.options.parse(f.data, i, r))
                : (d = f.data);
            } catch {
      ...
      },
      {
        ...
        value: function (t, n, i, r, o) {
          ...
          if (this.options.addPath) {
            typeof t == 'string' && (t = [t]);
            var l = this.options.parsePayload(n, i, r),
              u = 0,
              c = [],
              f = [];
            t.forEach(function (p) {
              ...
              typeof a.options.addPath == 'function' &&
                (h = a.options.addPath(p, n));
              var d = a.services.interpolator.interpolate(h, { lng: p, ns: n });
              a.options.request(a.options, d, l, function (m, y) {
                ((u += 1),
                  c.push(m),
                  f.push(y),
                  u === t.length && typeof o == 'function' && o(c, f));
              });
            });
          }
        },
                ...
                t.allOptions.ns.forEach(function (f) {
                  i.read(c, f, 'read', null, null, function (p, h) {
                    (p &&
                      ...
                      i.loaded(''.concat(c, '|').concat(f), p, h));
                  });
                });
              }));
          }
...
qe.type = 'backend';
const { slice: Gt, forEach: Zt } = [];
function en(s) {
  return (
    Zt.call(Gt.call(arguments, 1), (e) => {
...
const Fe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  nn = function (s, e) {
    ...
    if (n.domain) {
      if (!Fe.test(n.domain)) throw new TypeError('option domain is invalid');
      r += `; Domain=${n.domain}`;
    }
    if (n.path) {
...
var sn = {
    ...
    lookup(s) {
      ...
      if (e && typeof document < 'u') return Te.read(e) || void 0;
    },
    cacheUserLanguage(s, e) {
      ...
      t && typeof document < 'u' && Te.create(t, s, n, i, r);
    },
  },
  rn = {
    name: 'querystring',
  ...
  on = {
    ...
    lookup(s) {
      var i;
      let { lookupHash: e, lookupFromHashIndex: t } = s,
        n;
      if (typeof window < 'u') {
...
const De = () => {
  if (U !== null) return U;
  try {
    if (((U = typeof window < 'u' && window.localStorage !== null), !U))
      return !1;
...
var an = {
  ...
  cacheUserLanguage(s, e) {
    ...
    t && De() && window.localStorage.setItem(t, s);
  },
};
let H = null;
const Ie = () => {
  if (H !== null) return H;
  try {
    if (((H = typeof window < 'u' && window.sessionStorage !== null), !H))
      return !1;
    const s = 'i18next.translate.boo';
...
var ln = {
    ...
    cacheUserLanguage(s, e) {
      ...
      t && Ie() && window.sessionStorage.setItem(t, s);
    },
  },
  un = {
    name: 'navigator',
...
class Xe {
  ...
  init() {
    let e =
      ...
      n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    ((this.services = e),
      (this.options = en(t, this.options || {}, hn())),
...
function Pn({ children: s }) {
  return x.jsxs('html', {
    lang: 'en',
    children: [
      x.jsxs('head', {
        children: [
          x.jsx('meta', { charSet: 'utf-8' }),
          x.jsx('meta', {
            name: 'viewport',
...
const Cn = Qe(function () {
    return x.jsx(nt.Suspense, {
      fallback: x.jsx(ct, {}),
      children: x.jsx(it, {}),
    });
  }),
  kn = Ye(function ({ error: e }) {
    let t = 'Oops!',
